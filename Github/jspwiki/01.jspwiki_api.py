...
# url = repo.api_pull_jspwiki
url = 'https://api.github.com/repos/apache/jspwiki/pulls?state=closed&per_page=300&page='
...
data_list_api = cell_api(url, fromPage=1, toPage=50)
df = pd.json_normalize(data_list_api)
# df.to_csv("D:\origin-source-code-bill\Github\output\jspwiki.csv")