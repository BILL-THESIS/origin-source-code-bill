...
if __name__ == '__main__':
    ...
    df_issued_comments = pd.read_pickle("../output/ozone_filtered_issues_requests_comments.pkl")
    ...
    data_list_pull_url_api_not_nan.to_pickle("../output/ozone_filtered_issues_requests_comments_pulls.pkl")
