...
begin = pd.read_csv('ozone_group_begin.csv')
end = pd.read_csv('ozone_group_end.csv')
git_df = pd.read_csv('ozone_check_pull_1.csv')
# =============================================================================
...
df.to_csv('ozone_model.csv', index=False)