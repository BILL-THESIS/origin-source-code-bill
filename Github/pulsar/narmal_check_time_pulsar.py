...
if __name__ == '__main__':
    df = pd.read_pickle("../output/pulsar_filtered_issues_requests_comments_pulls.pkl")
    ...
    re_df_drop_nan.to_pickle("../output/pulsar_filtered_final_api.pkl")
    ...
    plt.title('Distribution of Total Time from Creation to Merge in pulsar Repository')
    plt.show()
