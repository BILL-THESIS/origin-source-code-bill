...
if __name__ == '__main__':
    df = pd.read_pickle("../output/seatunnel_filtered_issue_requests_comments_pulls_new.pkl")
    re_df = query_data(df)
    ...
    re_df_drop_nan.to_pickle("../output/seatunnel_filtered_final_api_new.pkl")
    ...
    plt.title('Distribution of Total Time from Creation to Merge on Seatunnel Repository')
    plt.show()
