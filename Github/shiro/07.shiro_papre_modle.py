...
begin = pd.read_csv('shiro_group_smell_begin.csv')
end = pd.read_csv('shiro_group_smell_end.csv')
git_df = pd.read_csv('../output/03.pull_to_sub_data_382.csv')
# =============================================================================
...
df = pd.DataFrame({
                    ...
                    'total_time': all_df['total_time_x'].astype('int64'),
...
df.to_csv('shiro_model.csv', index=False)