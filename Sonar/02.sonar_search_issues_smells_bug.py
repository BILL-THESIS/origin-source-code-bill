...
PAGE_SIZE = 500
# svae file name
PKL_FILE_NAME = "../Sonar/output/02.sonar_vulnerability_pull_smell_v4.pkl"
# read project file name
PROJECTS_PKL = "../Sonar/output/01.sonar_search_pull_v4.pkl"
...
def fetch_issues_for_project(sonar_client, project_key, page_size):
    ...
    while True:
        ...
        if len(issues) < page_size or total_fetched >= 10000:
            break
