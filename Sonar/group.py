...
df_extract_begin = pd.read_parquet('../Sonar/output/seatunnel_extract_begin.parquet')
df_extract_end = pd.read_parquet('../Sonar/output/seatunnel_extract_end.parquet')
