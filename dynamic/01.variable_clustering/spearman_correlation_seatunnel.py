...
if __name__ == "__main__":
    # significant level
    data_significant = pd.read_pickle('../output/seatunnel_all_status_significant.pkl')
    ...
    with open('../output/seatunnel_correlation_main_group.pkl', 'wb') as f:
    ...
    with open('../output/seatunnel_combinations.pkl', 'wb') as f:
