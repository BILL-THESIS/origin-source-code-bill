...
OUTPUT_DIR = os.path.join("/home/bill/origin-source-code-bill/dynamic/output/")
...
GROUP_FILEPATH = os.path.join(OUTPUT_DIR, f"{project_name}_correlation_group.pkl")
...
if __name__ == "__main__":
    ...
    try:
        for x_feature in feature_groups:
            ...
            X_arry, y_arry = smote.fit_resample(X_arry, y_arry)
            ...
            # ---------------------------------------------------------------------
            # เช็คตัวอย่างค่า y คือ 0 หรือ 1 มีจำนวนน้อยที่สุดเท่าไหร่
            ...
            study.optimize(objective, n_trials=1000, timeout=600, show_progress_bar=True)
