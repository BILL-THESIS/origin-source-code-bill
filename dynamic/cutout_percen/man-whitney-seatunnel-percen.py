...
def analyze_high_low_delta_row(results_df, percentiles=[0.1, 0.15, 0.2, 0.25, 0.3]):
...
if __name__ == "__main__":
    ...
    upper_group, low_group = analyze_high_low_delta_row(df)
    ...
    results = calculate_effect_size(results)
