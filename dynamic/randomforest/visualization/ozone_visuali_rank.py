...
if __name__ == "__main__":
    file_significant = "../../output/output_resample/ozone_all_status_significant.pkl"
    file_feature_importances = '../../output/output_resample/ozone_feature_importances.pkl'
    file_group_smell = "../../output/output_resample/ozone_rdf_quantile_all.pkl"
    file_each_smell = "../../output/output_resample/ozone_rdf_quantile_each_smell.pkl"
    file_main_group = "../../output/output_resample/ozone_correlation_main_group.pkl"
    ...
    data_original = pd.read_pickle("../../output/output_resample/ozone_compare.pkl")
    ...
    groups_factor = [group_by_feature_set[group_by_feature_set["feature"].isin(data_mian_group[i])] for i in range(4)]
    groups_factor_set1, groups_factor_set2, groups_factor_set3, groups_factor_set4 = groups_factor

    groups_factor_set1.sort_values(by='mean', ascending=False, inplace=True)
    groups_factor_set2.sort_values(by='mean', ascending=False, inplace=True)
    groups_factor_set3.sort_values(by='mean', ascending=False, inplace=True)
    groups_factor_set4.sort_values(by='mean', ascending=False, inplace=True)
