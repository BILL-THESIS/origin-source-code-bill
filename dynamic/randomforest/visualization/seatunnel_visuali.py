...
if __name__ == "__main__":
    ...
    data_compare = compare_group(grop_80_percen, data_each_smell)
    ...
    # plot_scatter(data_compare, important_feature)
    ...
    data_smell_time = data_original[['java:S1192_created', 'total_time']]

    set1 = group_by_feature_set[group_by_feature_set['feature'].isin(data_mian_group[0])]
