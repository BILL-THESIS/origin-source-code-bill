...
if __name__ == '__main__':
    ...
    optuna_all_case = joblib.load("../lightgbm/output_lightgbm/pulsar_optuna_result_each_smell.pkl")
    ...
    df_rank.to_pickle("output_rank/pulsar_optuna_result_rank_each_smell_lgbm.pkl")
