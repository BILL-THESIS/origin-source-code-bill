...
if __name__ == '__main__':
    ...
    optuna_all_case = joblib.load("../randomforest/output_randomforest/seatunnel_optuna_result_each_smell_rdf.pkl")
    ...
    df_rank.to_pickle("output_rank/seatunnel_optuna_result_rank_each_smell_rf.pkl")
