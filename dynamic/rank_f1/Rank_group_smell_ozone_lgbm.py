...
if __name__ == '__main__':
    ...
    pulsar_optuna = joblib.load("../lightgbm/output_lightgbm/ozone_optuna_result_each_smell.pkl")
    pulsar_optuna_all_case = joblib.load("../lightgbm/output_lightgbm/ozone_optuna_result_combinations_new.pkl")
    ...
    df_rank_new.to_pickle("output_rank/ozone_optuna_result_rank_lgbm.pkl")
