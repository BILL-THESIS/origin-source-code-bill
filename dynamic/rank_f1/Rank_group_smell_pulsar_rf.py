...
if __name__ == '__main__':
    ...
    pulsar_optuna_all_case = joblib.load("../randomforest/output_randomforest/pulsar_optuna_rf_combinations_new.pkl")
    ...
    df_rank_new.to_pickle("output_rank/pulsar_optuna_result_rank_rf.pkl")
