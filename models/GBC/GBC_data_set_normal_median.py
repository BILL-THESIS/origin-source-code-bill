...
def process_data(df, df_20_col, df_original):
    ...
    for _, row in df.iterrows():
        ...
        # print("df_col_combined", df_col_combined)
...
if __name__ == '__main__':
    ...
    df_divied_class = pd.read_parquet(directory_path_max)
    df_process = process_data(df_divied_class, df_20_col, df_original)
    ...
    # new_df.to_csv('../../models/GBC/GBC_10_data_set.csv')
    # new_df.to_pickle('../../models/GBC/GBC_10_data_sets.csv')
