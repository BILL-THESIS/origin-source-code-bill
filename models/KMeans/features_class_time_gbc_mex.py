...
def train_model(X_list, y_list, X_train_list, y_train_list, n_estimators=100, learning_rate=0.1, random_state=3,
    ...
    for X, y, X_train, y_train in zip(X_list, y_list, X_train_list, y_train_list):
        ...
        acc_y_smote = accuracy_score(y, y_pred_smote)
        ...
        #
        precision_macro_smote = precision_score(y, y_pred_smote, average='macro')
        recall_macro_smtote = recall_score(y, y_pred_smote, average='macro')
        f1_macro_smote = f1_score(y, y_pred_smote, average='macro')
        ...
        precision_macro_smote_list.append(precision_macro_smote)
        recall_macro_smote_list.append(recall_macro_smtote)
        f1_macro_smote_list.append(f1_macro_smote)
    ...
    return (sore_list, col_list,
            ...
            accuracy_score_list, accuracy_score_smote_list)
...
if __name__ == '__main__':
    ...
    (sore_list, col_list,
     precision_macro_list, recall_macro_list, f1_macro_list,
     precision_macro_smote_list, recall_macro_smote_list, f1_macro_smote_list,
     accuracy_score_list, accuracy_score_smote_list) = train_model(X_list_max, y_list_max, X_train_list_max, y_train_list_max)

    (sore_list_min, col_list_min, precision_macro_list_min, recall_macro_list_min, f1_macro_list_min,
     precision_macro_smote_list_min, recall_macro_smote_list_min, f1_macro_smote_list_min,
     accuracy_score_list_min, accuracy_score_smote_list_min) = train_model(X_list_min, y_list_min, X_train_list_min, y_train_list_min)
    ...
    new_df_normal_gbc = pd.DataFrame({
        ...
        'acc_y_pred_smote': accuracy_score_smote_list,
        ...
        'precision_macro_smote_min':precision_macro_smote_list_min,
        'recall_macro_smote_min': recall_macro_smote_list_min,
        'f1_macro_smote_min': f1_macro_smote_list_min,

        'acc_y_pred_min': accuracy_score_list_min,
        'acc_y_pred_smote_min': accuracy_score_smote_list_min
    })

    new_df_normal_gbc['f1_normal_max-min'] = new_df_normal_gbc['f1_macro'] - new_df_normal_gbc['f1_macro_min']
    # new_df_normal_gbc['f1_normal_min-max'] = new_df_normal_gbc['f1_macro_min'] - new_df_normal_gbc['f1_macro']
    new_df_normal_gbc['f1_smote_max-min'] = new_df_normal_gbc['f1_macro_smote'] - new_df_normal_gbc['f1_macro_smote_min']
    # new_df_normal_gbc['f1_smote_min-max'] = new_df_normal_gbc['f1_macro_smote_min'] - new_df_normal_gbc['f1_macro_smote']
