...
def process_data(df, df_20_col, df_original):
    ...
    for _, row in df.iterrows():
        ...
        # print("df_cluster_q1 value 1:", df_cluster_q1[0])
        # print("df_cluster_q1 value 2:", df_cluster_q1[1])
        # print("df_cluster_q1 value 3:", df_cluster_q1[2])

        df_cluster_q3 = row[['cluter0_q3', 'cluter1_q3', 'cluter2_q3']].sort_values()
        # print("df_cluster_q3 value 1:", df_cluster_q3[0])
        # print("df_cluster_q3 value 2:", df_cluster_q3[1])
        # print("df_cluster_q3 value 3:", df_cluster_q3[2])
...
def classify_time(df_list):
    ...
    for df_processed in df_list:
        ...
        df_processed['time_1_shape'] = [(counts[0] + counts[2]) - 1068] * len(df_processed)
...
def train_model(X_list, y_list, X_train_list, y_train_list):
    ...
    precision_weighted_tune_list = []
    recall_weighted_tune_list = []
    f1_weighted_tune_list = []
    ...
    precision_micro_tune_list = []
    recall_micro_tune_list = []
    f1_micro_tune_list = []
    ...
    for X, y, X_train, y_train in zip(X_list, y_list, X_train_list, y_train_list):
        ...
        y_pred_clf = clf.best_estimator_.predict(X_train)
        print("Y Pred Clf::", y_pred_clf)
        print("Y Pred Clf Shape::", y_pred_clf.shape)
        print("\n")
        ...
        precision_weighted_tune = precision_score(y_train, y_pred_clf, average='weighted')
        recall_weighted_tune = recall_score(y_train, y_pred_clf, average='weighted')
        f1_wetghted_tune = f1_score(y_train, y_pred_clf, average='weighted')
        ...
        precision_macro_tune = precision_score(y_train, y_pred_clf, average='macro')
        recall_macro_tune = recall_score(y_train, y_pred_clf, average='macro')
        f1_macro_tune = f1_score(y_train, y_pred_clf, average='macro')
        ...
        precision_micro_tune = precision_score(y_train, y_pred_clf, average='micro')
        recall_micro_tune = recall_score(y_train, y_pred_clf, average='micro')
        f1_micro_tune = f1_score(y_train, y_pred_clf, average='micro')
        ...
        precision_weighted_tune_list.append(precision_weighted_tune)
        recall_weighted_tune_list.append(recall_weighted_tune)
        f1_weighted_tune_list.append(f1_wetghted_tune)
        ...
        precision_macro_tune_list.append(precision_macro_tune)
        recall_macro_tune_list.append(recall_macro_tune)
        f1_macro_tune_list.append(f1_macro_tune)
        ...
        precision_micro_tune_list.append(precision_micro_tune)
        recall_micro_tune_list.append(recall_micro_tune)
        f1_micro_tune_list.append(f1_micro_tune)
    ...
    return (sore_list,col_list,
            ...
            precision_weighted_tune_list, recall_weighted_tune_list, f1_weighted_tune_list,
            precision_macro_tune_list, recall_macro_tune_list, f1_macro_tune_list,
            precision_micro_tune_list, recall_micro_tune_list, f1_micro_tune_list, y_pred)
...
if __name__ == '__main__':
    ...
    (sore_list, col_list,
     ...
     precision_weighted_tune_list, recall_weighted_tune_list, f1_weighted_tune_list,
     precision_macro_tune_list, recall_macro_tune_list, f1_macro_tune_list,
     precision_micro_tune_list, recall_micro_tune_list, f1_micro_tune_list, y_pred) = train_model(X_list, y_list, X_train_list, y_train_list)
    ...
    new_df_normal_svc = pd.DataFrame({
        ...
        'precision_weighted_tune': precision_weighted_tune_list,
        'recall_weighted_tune': recall_weighted_tune_list,
        ...
        'precision_micro_tune': precision_micro_tune_list,
