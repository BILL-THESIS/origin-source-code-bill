...
def qurtile_data(cluster_data):
    ...
    for i in cluster_data:
        ...
        for cluster_value in df_col_combined['label'].unique():
            ...
            quartile_data[f'shape_{cluster_value}_q3'] = [q3.shape]
            quartile_data[f'cluter{cluster_value}_q1'] = [q1]
            quartile_data[f'shape_{cluster_value}_q1'] = [q1.shape]
            quartile_data[f'shape_c{cluster_value}_more_q3'] = [equal_q3.shape]
            quartile_data[f'shape_c{cluster_value}_less_q1'] = [equal_q1.shape]
...
if __name__ == '__main__':
    ...
    df['distance_q3'] = df.apply(lambda row: (abs(row['cluter0_q3'][0] - row['cluter1_q3'][0]) +
    ...
    df['distance_q1'] = df.apply(lambda row: (abs(row['cluter0_q1'][0] - row['cluter1_q1'][0]) +
    ...
    df.to_parquet(f'output/q3_c3/q3_c3_normal_{time_str}.parquet')
