...
def process_cluster(cluster_data):
    ...
    return q1, q3, median, equal_q3, equal_q1
...
def qurtile_data(cluster_data):
    ...
    for i in cluster_data:
        ...
        for cluster_value in df_col_combined['label'].unique():
            ...
            q1, q3, median, equal_q3, equal_q1 = process_cluster(cluster_data)
            ...
            quartile_data[f'median_{cluster_value}'] = median
...
if __name__ == '__main__':
    ...
    equation_q3 = lambda row: (abs(row['cluter0_q3'][0] - row['cluter1_q3'][0]) +
                               ...
                               abs(row['cluter1_q3'][0] - row['cluter3_q3'][0]) +
                               abs(row['cluter2_q3'][0] - row['cluter0_q3'][0]) +
                               abs(row['cluter2_q3'][0] - row['cluter1_q3'][0]) +
                               abs(row['cluter2_q3'][0] - row['cluter3_q3'][0]) +
                               abs(row['cluter3_q3'][0] - row['cluter0_q3'][0]) +
                               abs(row['cluter3_q3'][0] - row['cluter1_q3'][0]) +
                               abs(row['cluter3_q3'][0] - row['cluter2_q3'][0])
                               ) / 4

    equation_q1 = lambda row: (abs(row['cluter0_q1'][0] - row['cluter1_q1'][0]) +
                               abs(row['cluter0_q1'][0] - row['cluter2_q1'][0]) +
                               abs(row['cluter0_q1'][0] - row['cluter3_q1'][0]) +
                               abs(row['cluter1_q1'][0] - row['cluter0_q1'][0]) +
                               abs(row['cluter1_q1'][0] - row['cluter2_q1'][0]) +
                               abs(row['cluter1_q1'][0] - row['cluter3_q1'][0]) +
                               abs(row['cluter2_q1'][0] - row['cluter0_q1'][0]) +
                               abs(row['cluter2_q1'][0] - row['cluter1_q1'][0]) +
                               abs(row['cluter2_q1'][0] - row['cluter3_q1'][0]) +
                               abs(row['cluter3_q1'][0] - row['cluter0_q1'][0]) +
                               abs(row['cluter3_q1'][0] - row['cluter1_q1'][0]) +
                               abs(row['cluter3_q1'][0] - row['cluter2_q1'][0])
                               ) / 4

    df['distance_q3'] = df.apply(equation_q3, axis=1)
    df['distance_q1'] = df.apply(equation_q1, axis=1)
