...
if __name__ == '__main__':
    ...
    with open(os.path.join('../../KMeans/output/class_time_3_smote_new.parquet'), 'rb') as f:
        df_class_3_smote_new = joblib.load(f)

    # print('df_class_3_smote describe', df_class_3_smote.describe())
    # print("\n")

    # Convert 'time01' and 'time12' to total seconds in hours
    # df_class_3_smote_new['time01'] = pd.to_timedelta(df_class_3_smote_new['time01']).dt.total_seconds() / 3600
    # df_class_3_smote_new['time12'] = pd.to_timedelta(df_class_3_smote_new['time12']).dt.total_seconds() / 3600

    df_unutilized, df_utilize = sort_percentile_f1(df_class_3_smote_new)
    print('df unutilized describe', df_unutilized.describe())
    print("\n")
    print('df_utilize describe', df_utilize.describe())
    ...
    df_utilize.to_pickle('../../KMeans/output/class_time_3_smote_utilize_robust_outline.pkl')