...
if __name__ == '__main__':
    # Load the data
    data_api = pd.read_parquet('../../models/output/pulsar_prepare_to_train_newversion_9Sep.parquet')
    ...
    with open('../../models/output/pulsar_test_model_rfc_timeclass3_28Sep.parquet', 'wb') as f:
