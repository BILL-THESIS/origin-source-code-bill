...
if __name__ == '__main__':
    ...
    ozone_check_values_gbc = sort_values_time(ozone_class3_gbc, 0.2)
    ozone_check_values_svc = sort_values_time(ozone_class3_svc, 0.2)
    ozone_check_values_rfc = sort_values_time(ozone_class3_rfc, 0.2)

    seatunnal_check_values_gbc = sort_values_time(seatunnal_class3_gbc, 0.2)

    pulsar_check_values_gbc = sort_values_time(pulsar_class3_gbc, 0.2)
    pulsar_check_values_svc = sort_values_time(pulsar_class3_svc, 0.2)

    ozone_20percen_gbc_ture = ozone_check_values_gbc[ozone_check_values_gbc['diff_time'] == True]
    ozone_20percen_svc_ture = ozone_check_values_svc[ozone_check_values_svc['diff_time'] == True]
    ozone_20percen_rfc_ture = ozone_check_values_rfc[ozone_check_values_rfc['diff_time'] == True]

    pulsar_20percen_gbc_ture = pulsar_check_values_gbc[pulsar_check_values_gbc['diff_time'] == True]
    pulsar_20percen_svc_ture = pulsar_check_values_svc[pulsar_check_values_svc['diff_time'] == True]